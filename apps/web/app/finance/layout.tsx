...
export const metadata: Metadata = {
  ...
  description:
    "Manage your business finances with CresOS by Cres Dynamics. Track invoices, payments, expenses, revenue, and financial reports in one integrated system.",
  keywords: [
    "Cres Dynamics finance",
    "CresOS finance",
    "Business OS accounting",
    "Invoice management",
    "Payment tracking",
    "Revenue analytics",
    "Financial reports"
