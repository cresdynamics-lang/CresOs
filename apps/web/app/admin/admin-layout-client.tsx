...
export function AdminLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  if (!hydrated || !auth.accessToken) {
    return (
      <div
        className={`${adminNeu.workspace} admin-fullscreen ${adminNeu.canvas} flex h-full items-center justify-center text-sm font-medium text-[#424242]`}
      >
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        <div className="shrink-0 border-b border-[#e1dfdd] bg-white px-3 py-2 md:hidden">
          <AdminNav />
        </div>
