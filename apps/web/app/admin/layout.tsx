...
export const metadata: Metadata = {
  ...
  description:
    "Administer your CresOS workspace by Cres Dynamics. Manage users, roles, departments, and system settings for your business operating system.",
  keywords: [
    "Cres Dynamics admin",
    "CresOS administration",
    "User management",
    "Role management",
    "System settings",
    "Workspace admin",
