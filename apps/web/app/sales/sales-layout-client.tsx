...
export function SalesLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <aside className="hidden w-[15rem] shrink-0 flex-col border-r border-white/[0.06] bg-[#0e1118]/90 md:flex">
        <div className="border-b border-white/[0.06] px-4 py-4">
          <p className="font-label text-[10px] font-semibold uppercase tracking-[0.22em] text-amber-400/90">
            Sales
          </p>
          <p className="mt-1 text-xs leading-relaxed text-slate-500">Pipeline, delivery &amp; reports</p>
        </div>
