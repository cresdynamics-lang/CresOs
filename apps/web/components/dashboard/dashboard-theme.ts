...
export const dashboardNeu = {
  ...
  hero:
    "relative overflow-hidden rounded-3xl border border-sky-200/80 bg-white p-5 shadow-sm sm:p-7",
  heroGlow:
  ...
  kpiTile:
    "group relative flex min-h-[6.25rem] flex-col justify-between overflow-hidden rounded-2xl border border-sky-200/80 bg-white p-4 shadow-sm transition-all hover:border-brand/40 hover:shadow-md",
  ...
  queueItem: "rounded-xl border border-sky-100 bg-[#f8fbfe] px-4 py-3",
  btnGhost: lightSurface.btnGhost,
  btnPrimary: lightSurface.btnPrimary,
  tasksStrip:
    "flex flex-col gap-3 rounded-xl border border-sky-100 bg-[#f5f9fc] px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between",
