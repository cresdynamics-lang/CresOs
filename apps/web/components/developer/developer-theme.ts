...
export const devNeu = {
  ...
  btnPrimary:
    "rounded-xl bg-gradient-to-br from-violet-600 to-indigo-700 px-4 py-2 text-sm font-semibold text-white shadow-[4px_4px_12px_rgba(0,0,0,0.45),-2px_-2px_8px_rgba(139,92,246,0.15)] hover:from-violet-500 hover:to-indigo-600 active:shadow-[inset_3px_3px_8px_rgba(0,0,0,0.5)]",
  statViolet:
