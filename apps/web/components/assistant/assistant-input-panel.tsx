  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button type="button" disabled={loading} onClick={() => void onSubmit()} className={primaryBtn}>
        ...
        <button
          ...
          className={`rounded-xl border px-4 py-2 text-sm font-medium ${recBtn}`}
        >
        ...
        {onAudioFile ? (
          <>
            ...
            <button
              ...
              className={`rounded-xl border px-4 py-2 text-sm font-medium disabled:opacity-50 ${ghostBtn}`}
            >
              📎 Audio file
            </button>
          </>
