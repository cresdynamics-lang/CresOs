/** Dark neumorphism tokens for the Admin workspace (indigo accent). */
export const adminNeu = {
  ...
  navActive:
    "bg-[#121820] text-indigo-300 shadow-[inset_3px_3px_8px_rgba(0,0,0,0.45),inset_-2px_-2px_6px_rgba(255,255,255,0.04)] border border-indigo-500/20",
  btnPrimary:
    "rounded-xl bg-gradient-to-br from-indigo-600 to-violet-700 px-4 py-2 text-sm font-semibold text-white shadow-[4px_4px_12px_rgba(0,0,0,0.45),-2px_-2px_8px_rgba(99,102,241,0.15)] hover:from-indigo-500 hover:to-violet-600",
  btnGhost:
  ...
  statIndigo:
    "border-indigo-500/15 bg-[#10141a] shadow-[5px_5px_12px_rgba(0,0,0,0.5),-3px_-3px_10px_rgba(99,102,241,0.06)]",
  statEmerald:
  ...
  alertInfo:
    "rounded-xl border border-indigo-500/20 bg-[#10141a] shadow-[4px_4px_12px_rgba(0,0,0,0.45),-2px_-2px_8px_rgba(99,102,241,0.05)]",
  chartPanel:
